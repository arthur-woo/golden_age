        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "run_type",
                    models.CharField(
                        choices=[("SCHEDULED", "스케줄됨"), ("MANUAL", "수동")], max_length=32
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_delta",
                    models.DecimalField(
                        decimal_places=8, help_text="수량 증감", max_digits=18
                    ),
                ),
                (
                    "price",
                    models.DecimalField(
                        decimal_places=2, help_text="기준 가격", max_digits=18
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cash_balance",
                    models.DecimalField(
                        decimal_places=2, help_text="현금 잔고", max_digits=18
                    ),
                ),
                (
                    "total_asset_value",
                    models.DecimalField(
                        decimal_places=2, help_text="총 평가 금액", max_digits=18
                    ),
                ),
                (
                    "snapshot_payload",
                    models.JSONField(blank=True, default=dict, help_text="상세 스냅샷"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, help_text="증감 금액", max_digits=18
                    ),
                ),
